...
| `billing-tabs.png` | Коммуналка и счётчики (Финансы) | [06-billing.md](../ru/06-billing.md) |
| `finance-turnover.png` | Финансы → Сводная ведомость (с переключателем «Базис») | [07-finansy.md](../ru/07-finansy.md) |
| `finance-income.png` | Финансы → Доходы (карточки-источники) | [07-finansy.md](../ru/07-finansy.md) |
| `finance-analysis.png` | Финансы → «Анализ изменений» (водопад, драйверы) | [07-finansy.md](../ru/07-finansy.md) |
