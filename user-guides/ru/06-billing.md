# Биллинг (коммунальные услуги)

Раздел **«Биллинг»** предназначен для учёта **коммунальных ресурсов** по помещениям: типы услуг (электроэнергия, вода, тепло и т.д.), **счётчики**, внесение **показаний** и формирование **счетов**.
