...
На **«Главной»** владельца — карточка **«Связь с поддержкой»**:

- Информационная подсказка: обращение будет передано в поддержку MyWay, история — в таблице ниже.
- Форма: **Тема**, **Сообщение**, кнопка **«Написать в поддержку»**.
- Таблица входящих и исходящих сообщений: **Направление** (`От SUPER_ADMIN` / `Ваше сообщение`), **Тема**, **Сообщение**, **Статус** (`Доставлено` или `Доставлено в системе`), **Создано**.
