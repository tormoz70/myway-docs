...
- Основа для **публичной витрины** (`/go/<slug>`) и форм записи преподавателя/ученика.
- Управление **ценами за занятие** через тарифные планы (в копейках внутри системы, в формах часто вводится в рублях).

## Таблица предметов

Колонки: **Название**, **Каталог** (переключатель «да»/«нет» — видимость на публичном сайте), **Преподаватели**, **Ученики**, действия в строке.

Кнопки в строке:

- **Тарифные планы** — модал тарифов по предмету;
- **Зачисление учеников** — привязка ученика и тарифа;
