...
MyWay — веб-приложение для студий и школ: расписание, учёт посещений и пропусков, биллинг помещений, субаренда, финансовые отчёты (при включённом тарифе), публичная страница организации и приём заявок от преподавателей и студентов.
...
| Запись студентом | `/go/<slug>/join/student` |
...
| `STUDENT` | Студент: расписание, пропуска, отметка прохода. |
