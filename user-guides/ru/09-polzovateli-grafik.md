...
**Опечатка в email:** откройте карточку участника (карандаш), исправьте **Email** и сохраните. Для ролей **администратор / преподаватель / уборщица** на **новый** адрес всегда уходит письмо с **новым** временным паролем; старый пароль перестаёт действовать, при следующем входе потребуется смена пароля. Уведомление: *«Email обновлён, новые данные для входа отправлены на почту»*.
