...
| TC-OPS-MON-01…08 | мониторинг пилота / локальный оверлей, включая вкладку «Мониторинг» в кабинете платформы, переход в Grafana и мобильную раскладку вкладки; [ops-monitoring.md](cases/ops-monitoring.md) |
